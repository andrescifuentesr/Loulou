...
get_header(); ?>
	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main template-photos" role="main">
		...
		jQuery(function($){
			...
			$.supersized({
				...
				slides 					:  	[			// Slideshow Images
															...
															{image : 'http://localhost:8888/Food2Vous/loulou/wp-content/uploads/2014/05/image-slider-02.jpg', title : 'Restaurant Esprit du 12eme'}
											],
